...
FlowVertexStrength=0.12
FlowWaveStrength=1.56
FlowLongitudinalWaveStrength=1.18
FlowTransverseWaveStrength=1.12
FlowReliefStrength=1.28
FlowRefractionReliefStrength=1.24
FlowVolumeWaveStrength=0.96
FlowSpeed=1.00
FlowSecondaryMotion=1.00
FlowOriginalDeformation=1.00
FlowOriginalSync=1.00
FlowRefractionWarp=1.66
FlowSurfaceDistortion=2.34
FlowSurfaceTension=1.18
FlowCrossDistortion=2.22
FlowCrossWaveStrength=0.32
...
FlowBumpMappingStrength=0.94
SyntheticBumpMappingStrength=0.78
VerboseLog=0
PerfTelemetry=0
```
