...
vec4 trshaderSyntheticFlowPattern(vec2 trshaderP, float trshaderTime, float trshaderSpeed, vec4 trshaderPatchField){
 ...
 float trshaderCrest=trshaderSat(trshaderStream*.30+trshaderLane*.30+trshaderRibbon*.32+trshaderStreak*.28+
   ...
   trshaderEddy*.14+abs(trshaderChop)*.11*TR456_WATER_FLOW_BREAKUP);
 ...
 float trshaderFoam=(trshaderLineMask(trshaderStreamCoord+trshaderN2*.18,10.0)*.18+trshaderLineMask(trshaderFineCoord+trshaderN0*.24,22.0)*.16+
   ...
   trshaderSwirl*.12+trshaderCrest*trshaderCrest*.14)*TR_TOGGLE_FLOW_FOAM;
...
vec3 trshaderContactField(vec3 trshaderW, float trshaderT){
 ...
 for(int trshaderI=0;trshaderI<16;trshaderI++){
  ...
  float trshaderFalloff=trshaderContactOn*trshaderVertical*(1.0-smoothstep(trshaderRadius*.10,trshaderRadius*2.85,trshaderDist))*exp(-trshaderDist/(trshaderRadius*1.12));
  float trshaderPhase=trshaderDist*.047-trshaderT*3.85+trshaderAge*.075+float(trshaderI)*.41;
  ...
  trshaderRingSharp*=trshaderRingSharp;
  trshaderSlope+=trshaderDir*cos(trshaderPhase)*trshaderFalloff*trshaderSlopeStrength;
...
vec4 trshaderContactWakeField(vec3 trshaderW, float trshaderT, vec2 trshaderPrimaryDir){
 ...
 for(int trshaderI=0;trshaderI<16;trshaderI++){
  ...
  float trshaderAlong=dot(trshaderD,trshaderFlowDir)/max(trshaderRadius,1.0);
  float trshaderSide=dot(trshaderD,trshaderSideDir)/max(trshaderRadius,1.0);
  float trshaderAge=mod(abs(trshaderC.w),512.0);
  ...
  float trshaderSideFalloff=exp(-trshaderFastPow2(trshaderSide/max(trshaderSideWidth,.001)));
  ...
  float trshaderStreak=trshaderContactOn*trshaderVertical*trshaderLengthWindow*trshaderSideFalloff*
    (.44+.56*trshaderMotionEnergy)*(.62+.38*trshaderBroken);
  float trshaderRidge=trshaderSat(sin(trshaderPhase)*.5+.5);
  trshaderSlope+=trshaderFlowDir*(sin(trshaderPhase)*trshaderStreak*.18+trshaderRidge*trshaderStreak*.060)+
    trshaderSideDir*(-trshaderSide*trshaderStreak*(.16+.10*trshaderMotionEnergy));
...
TrshaderSyntheticFrame trshaderBuildSyntheticFrame(vec2 trshaderScreen, float trshaderT){
 ...
 trshaderF.trshaderContacts=trshaderContactField(vSynWorldPos,trshaderT);
 float trshaderStandingProfile=1.0-smoothstep(2.35,2.95,uTrWaterSyntheticProfile.x);
 ...
 trshaderF.trshaderSlope=trshaderF.trshaderBaseField.xy*.78+trshaderF.trshaderContacts.xy*1.65+trshaderF.trshaderRainRipples.xy*1.80+
   ...
   trshaderF.trshaderRelief.xy*trshaderReliefSlopeStrength+trshaderF.trshaderAlive.xy*.48;
...
vec4 trshaderRenderSurfaceFlow(TrshaderSyntheticFrame trshaderF, vec2 trshaderFlowDir, vec2 trshaderFlowSide,
 ...
 float trshaderTensionLineA=trshaderLineMask(trshaderFlowUv.x*5.8+trshaderEdgeNoise*.42-
  ...
  vec2 trshaderFlowContactSlope=(trshaderF.trshaderContacts.xy*1.35+trshaderF.trshaderContactWake.xy*.72)*
    trshaderFlowContactStrength;
  float trshaderFlowContactEnergy=trshaderSat((trshaderF.trshaderContacts.z*.44+trshaderF.trshaderContactWake.z*.72+
    trshaderF.trshaderContactWake.w*.58)*trshaderFlowContactStrength);
 ...
 if(trshaderReflectActive>.001) {
  ...
  trshaderReflected=trshaderReflectionGrade(mix(trshaderSceneRefl,trshaderMirrorRefl,
    trshaderSat(.24+trshaderFlowFres*.54+trshaderFlowDepth*.18)));
  trshaderReflMask=trshaderSat((.006+trshaderFlowFres*.045+trshaderFlowSignal*.007+trshaderFlowDepth*.004)*
 ...
 vec3 trshaderCol=mix(trshaderFlowBody,trshaderReflected,trshaderReflMask*.075);
...
vec4 trshaderRenderCalmFlowSurface(TrshaderSyntheticFrame trshaderF, vec2 trshaderFlowDir, vec2 trshaderFlowSide,
 ...
 float trshaderCrossStrength=clamp(TR456_WATER_FLOW_CROSS_WAVE,0.0,2.0);
  ...
  float trshaderCalmCrossRefract=(trshaderCalmCrossShear*.70+trshaderCalmCrossCounter*.30*
   ...
   float trshaderFlowContactStrength=clamp(TR456_WATER_FLOW_CONTACT_STRENGTH,0.0,3.0)*
     TR_TOGGLE_CONTACT_RIPPLES;
   float trshaderFlowContactNormal=clamp(TR456_WATER_FLOW_CONTACT_NORMAL,0.0,3.0);
   vec2 trshaderCalmContactSlope=(trshaderF.trshaderContacts.xy*.45+trshaderF.trshaderContactWake.xy*.42)*
     trshaderFlowContactStrength;
   float trshaderCalmContactEnergy=trshaderSat((trshaderF.trshaderContacts.z*.30+trshaderF.trshaderContactWake.z*.58+
     trshaderF.trshaderContactWake.w*.44)*trshaderFlowContactStrength);
 ...
 if(trshaderReflectActive>.001) {
  ...
  trshaderReflected=trshaderReflectionGrade(mix(trshaderSceneRefl,trshaderMirrorRefl,
    trshaderSat(.14+trshaderCalmFres*.38+trshaderFloorDepth*.10)));
  trshaderReflectionMask=trshaderSat((.020+trshaderCalmFres*.12+trshaderFloorDepth*.018)*
 ...
 trshaderFoamMask=trshaderSat(trshaderFoamMask+trshaderDirectionalFoam*.24);
  ...
  vec3 trshaderWaterBody=mix(trshaderWaterBase,trshaderReflected*.82+trshaderTint*.045,trshaderReflectionMask*.10);
...
vec4 trshaderRenderStandingWater(TrshaderSyntheticFrame trshaderF){
 ...
 vec2 trshaderWarp=(trshaderF.trshaderSlope*.0114+trshaderF.trshaderNormal.xz*.0078+
   trshaderF.trshaderRelief.xy*.00325+trshaderF.trshaderAlive.xy*.00125)*trshaderRefractAmt*trshaderViewWarp;
 ...
 trshaderReflected=trshaderReflectionGrade(mix(trshaderReflected,trshaderMirrorRef,trshaderMirrorMask));
 trshaderReflectionMask=trshaderSat((.045+trshaderF.trshaderFresnel*.24+trshaderFloorDepth*.035)*
 ...
 float trshaderRippleMemory=pow(trshaderSat(trshaderF.trshaderRainRipples.z+trshaderF.trshaderContacts.z*.40+
   trshaderF.trshaderContactWake.z*.30+trshaderF.trshaderWaterfallWaves.z*.18),1.25);
 float trshaderCrest=trshaderSat(trshaderF.trshaderBaseField.z*.28+.30+trshaderF.trshaderAlive.z*.18)+
   ...
   trshaderF.trshaderWaterfallWaves.z*.62+trshaderRippleMemory*.18;
 ...
 float trshaderStandingCompositeAlpha=clamp(.24+trshaderOpacity*.50+
   ...
   trshaderReflectionMask*.08+trshaderHaze*.05+trshaderTensionFilm*.035,.30,.68);
