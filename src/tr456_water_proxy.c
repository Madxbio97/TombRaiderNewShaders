...
static char *flow_lite_fragment_shader(void) {
  return trshader_dup_text(
    ...
    " vec3 paintedBase=mix(procBase,texWater,0.58)+tint*(0.14+waterStrength*0.16);\n"
    ...
    " vec3 water=mix(underBase,paintedBase,0.46);\n"
    " water=mix(water,scene*vec3(0.70,0.82,0.88)+tint*0.34,0.20*(1.0-sceneEdge*0.45)*uTrWaterFlowFx0.y*uTrWaterToggle0.y);\n"
