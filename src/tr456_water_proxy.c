...
static char *flow_lite_fragment_shader(void) {
  return trshader_dup_text(
    ...
    " float tremble=(sin(uv.x*42.0+uv.y*14.0+travel*8.60)*0.46+sin(uv.y*37.0-uv.x*10.0-travel*7.40)*0.34+sin(dot(uv,vec2(55.0,-31.0))+travel*10.20)*0.20)*uTrWaterFlowFx2.w*uTrWaterToggle1.x;\n"
    " float trembleCross=sin(uv.y*49.0+uv.x*6.2+travel*9.35)*uTrWaterFlowFx2.w*uTrWaterToggle1.x;\n"
