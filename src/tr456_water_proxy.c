...
static void build_shader_defines(char *out, size_t out_size) {
  ...
  const int synthetic_flow_contacts=ini_int("SyntheticFlowContacts",0) ? 1 : 0;
  ...
  snprintf(out,out_size,
    ...
    "#define TR456_WATER_SYNTHETIC_FLOW_CONTACTS %d\n"
